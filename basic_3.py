...
Input parameters:-
func: The function to be called. In this case, its the basicDPSolver function.  
*args: The arguments for the 'func' function. 

Output:-
All the outputs by the 'func' function (In this casee it's the output by the basicDPSolver function) along 
...
if __name__ == "__main__":
    ...
    # Solving the string alignment problem using basic dymainic programming and getting the alignment cost, and two aligned strings along with the time elapsed in milli-seconds. 
    alignmentCost,firstStringAlignment,secondStringAlignment, timeTaken = time_wrapper(basicDPSolver,firstInputString,secondInputString)

    # Getting the memory consumed in KB
    memoryConsumed = process_memory()

    # Writing the output to the output file.
    outputFile = open(outputFilePath, "w") #output file 
